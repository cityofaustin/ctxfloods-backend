  ...
  describe('as ' + username + ' ' + (extra_description || ''), () => {
    ...
    describe('before updating', () => {
      ...
      it('it should get the current status', async () => {
        ...
        originalStatusId =
          response.crossingById.statusUpdateByLatestStatusUpdateId.id;
        expect(response).not.toBeNull();
      });
    ...
    it('the new status should show up in the DB', async () => {
      ...
      expect(
        response.crossingById.statusUpdateByLatestStatusUpdateId.id,
      ).not.toEqual(originalStatusId);
      expect(
        response.crossingById.statusUpdateByLatestStatusUpdateId.id,
      ).toEqual(newStatusId);
      expect(
        response.crossingById.statusUpdateByLatestStatusUpdateId.notes,
      ).toMatchSnapshot();
    });
    ...
    it('the second crossing should still have the original status', async () => {
      ...
      expect(
        response.crossingById.statusUpdateByLatestStatusUpdateId.id,
      ).toEqual(secondOriginalStatusId);
      expect(
        response.crossingById.statusUpdateByLatestStatusUpdateId.notes,
      ).toMatchSnapshot();
    });
  ...
  describe('To CLOSED', () => {
    describe('with no REASON or DURATION', () => {
      shouldFail(
        ...
        2,
        3,
        'CLOSED with no REASON or DURATION',
      );
      shouldFail(
        communityAdminEmail,
        everyPassword,
  ...
  describe('To CAUTION', () => {
    describe('with no REASON or DURATION', () => {
      shouldFail(
        ...
        everyPassword,
        3,
        'CAUTION with no REASON or DURATION',
      );
      shouldFail(
        communityAdminEmail,
        everyPassword,
  ...
  describe('To LONG TERM CLOSURE', () => {
    describe('with no REASON or DURATION', () => {
      shouldFail(
        ...
        4,
        3,
        'LONG TERM CLOSURE with no REASON or DURATION',
      );
      shouldFail(
        communityAdminEmail,
        everyPassword,
