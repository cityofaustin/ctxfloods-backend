...
select floods.register_user(text 'Floods', text 'Graphql', text 'API', integer '1', text '000-0000', text 'graphql@flo.ods', text 'floods_graphql', text 'floods_super_admin');
