...
async function addCrossing(lokka, crossing) {
  console.log("addCrossing", crossing)
  console.log("type:", typeof crossing)
  console.log("keys:", Object.keys(crossing))
  try {
    let response = await lokka.send(
      `
    ...
    console.error("Error in addCrossing");
    console.error(err)
    throw err
  }
...
async function addCrossingToCommunity(lokka, crossingId, communityId) {
  console.log("addCrossingToCommunity", crossing)
  let response;
  try {
    response = await lokka.send(
      `
    ...
    console.error("Error in addCrossingToCommunity");
    console.error(err)
    throw err
  }
